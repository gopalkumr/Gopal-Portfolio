...
export default {
  ...
  computed: {
    ...
    preview() {
      return require('~/assets/images/headshots--fd1.png')
    },
    previewWebp() {
      return require('~/assets/images/headshots--fd1.png?format=webp')
    },
    previewAvif() {
      return require('~/assets/images/headshots--fd1.png?format=avif')
    },
    srcset() {
      return require(`~/assets/images/headshots1.png`)
    },
    srcsetWebp() {
      return require(`~/assets/images/headshots1.png?format=webp`)
    },
    srcsetAvif() {
      return require(`~/assets/images/headshots1.png?format=avif`)
    }
  },
  mounted() {
    this.mounted = true
